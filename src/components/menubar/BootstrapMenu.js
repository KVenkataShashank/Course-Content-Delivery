...
const BootstrapMenu = () => {
    ...
    useEffect(() => {
        axios
            .get("http://ngel2.hyderabad.cdac.in:8082/courseOrganizer/getCourseStructure/1")
            .then((res) => {
    ...
    useEffect(() => {
        // axios
        //     .get(`http://ngel2.hyderabad.cdac.in:8080/${globalContextState.currentPath}`)
        //     .then((response) => {
        ...
        const Extension = () => {
            ...
            if (
                ...
                return (
                    <div>
                        <iframe
                            src={`http://ngel2.hyderabad.cdac.in:8080/${url}`}
                            width="100%"
                            height="700px"
                ...
                return (
                    < div >
                        < ReactPlayer
                            url={`http://ngel2.hyderabad.cdac.in:8080/${url}`}
                            width="100%"
                            height="800px"
                            controls="true"
                            config={{
